console.log("Para rodar e compilar o arquivo em TypeScript, utilize os seguintes comandos no terminal:");

console.log("node aula02.ts");

console.log("tsc aula02.ts");
